...
var Harry
var Guardia, Mutante,BalasrecibidasMutante1=0
var Guardias 
var coleccionables
var municion
...
if(keyWentDown(32)){
    municion = createSprite(Harry.x,Harry.y,20,20)
    municion.velocityX=30
    municion.visible=true
...
function accionesMutante(){

  Mutante.bounceOff(pared4)
  Mutante.bounceOff(pared2)
  if(Mutante.isTouching(Harry)){
    Harry.destroy()
  }
  if(municion.isTouching(Mutante)){
    municion.destroy()
    BalasrecibidasMutante1=BalasrecibidasMutante1+1
    
    console.log("contador",BalasrecibidasMutante1)
    
  }
  if(BalasrecibidasMutante1==10){
    Mutante.destroy()
  }
}
